GITHUB_USER=lukeweston
GITHUB_API_TOKEN=2c4997660debc75562fc64304df91e02

# Project name = directory name.
PROJECT_NAME=WiFiShield
#PROJECT_NAME=LaserCutter2
...
gerbers :
	...
	# Only for boards where there is NO bottom silkscreen.
	touch ./gerbers/$(PROJECT_NAME).GBO
	rm ./gerbers/$(PROJECT_NAME).GBO

	zip $(PROJECT_NAME)-gerbers.zip ./gerbers/*.*
